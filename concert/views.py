    ...
    if request.method == "POST":
        ...
        try:
            ...
            if user:
                ...
                user = User.objects.create(username=username, password=make_password(password)) # Créer le nouvel utilisateur
                login(request, user) # Connecter le nouvel utilisateur
                return HttpResponseRedirect(reverse("index")) # Rediriger vers la page d'accueil
